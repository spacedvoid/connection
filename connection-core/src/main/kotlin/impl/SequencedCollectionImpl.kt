...
open class SequencedCollectionImpl<out T>(override val kotlin: java.util.SequencedCollection<@UnsafeVariance T>): SequencedCollection<T>, SequencedCollectionViewImpl<T>(kotlin) {
