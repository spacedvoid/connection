...
fun <T> CollectionView<T>.toKotlin(): KotlinCollection<T> = this.copy().asView().asKotlin()
...
fun <T> SequencedCollectionView<T>.toKotlin(): java.util.SequencedCollection<T> = this.copy().asView().asKotlin()
...
fun <T> ListView<T>.toKotlin(): KotlinList<T> = this.copy().asView().asKotlin()
...
fun <T> SortedNavigableSetView<T>.toKotlin(): java.util.SortedSet<T> = this.copy().asView().asKotlin()
...
fun <T> NavigableSetView<T>.toKotlin(): java.util.NavigableSet<T> = this.copy().asView().asKotlin()
...
fun <K, V> MapView<K, V>.toKotlin(): KotlinMap<K, V> = this.copy().asView().asKotlin()
...
fun <K, V> SequencedMapView<K, V>.toKotlin(): java.util.SequencedMap<K, V> = this.copy().asView().asKotlin()
...
fun <K, V> NavigableMapView<K, V>.toKotlin(): java.util.NavigableMap<K, V> = this.copy().asView().asKotlin()
